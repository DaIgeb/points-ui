...
import { Header, Navigation, Tours, People, Routes, PrivateRoute, YearReport, TourReport } from './components';
    ...
    return (
      ...
      >
        <Switch>
          ...
          <PrivateRoute path="/reports/year" component={YearReport} />
          <PrivateRoute path="/reports/tour" component={TourReport} />
          <PrivateRoute
            path="/callback"
            render={(props) => {
